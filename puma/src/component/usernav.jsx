        ...
        <div className="usernav">
              ...
              <div className="image">
                    ...
                    <ul>
                        ...
                        <li><Link to="/userportal/women"className="Link">Women</Link></li>
                        <li><Link to="/userportal/men" className="Link">Men</Link></li>
                        <li><Link to="/userportal/kid"className="Link">Kid</Link></li>
                        <li><Link to="/userportal/spcl"className="Link">Special Addition</Link></li>
